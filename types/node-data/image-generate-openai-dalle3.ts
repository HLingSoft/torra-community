...
export interface ImageGenerateOpenAIDALLE3Data {
    title: string
    type: string
    icon?: string
    description: string
...
export const ImageGenerateOpenAIDALLE3LangchainName = 'ImageGenerateOpenAIDALLE3'

export const imageGenerateOpenAIMeta: ImageGenerateOpenAIDALLE3Data = {
    title: 'Image Generation OpenAI DALL·E 3',
    description: 'Use OpenAI to generate images based on text instructions. DALLE-3 is recommended for best results.',
    type: ImageGenerateOpenAIDALLE3LangchainName,
