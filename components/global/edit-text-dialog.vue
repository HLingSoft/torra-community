...
<template>
  <div v-bind="$attrs">
    <div v-if="!props.disabled" class="relative w-full">
      <Input v-model="localValue" type="text" :placeholder="placeholder || 'Typing something'" class="w-full pr-10 dark " />
    ...
    <div v-else class="relative">
      <Input disabled class="w-full dark" type="text" placeholder="Receiving input" />
