      ...
      <template #content v-if="currentNode && currentNode.data">
        ...
        <div class="relative ">
          ...
          <div class="w-full  mt-5">
            ...
            <EditTextDialog v-model:input-variable="currentNode.data.historyMessageInputVariable" :show-input="false" :handle-bg="`oklch(82.3% 0.12 346.018)`" />
          </div>
          <!-- <Handle type="target" :id="currentNode.data.historyMessageInputVariable.id" :connectable-start="false" :position="Position.Left" :style="{ top: '12px', left: '-25px' }" /> -->
        ...
        <div class="w-full">
          ...
          <div class="w-full flex items-center justify-between  mt-4">
            <Select v-model="currentNode.data.modelName" class="w-full">
              ...
              <SelectContent class="w-full dark" telepor="body">
                <SelectGroup>
