...
import { saveToFileLCMeta, EXT_MIME_MAP } from '~~/types/node-data/save-file-to-local'
const props = defineProps<{ id: string }>()
const currentNode = ref<{ id: string, data: SaveToFileLCData } | null>(null)
...
<template>
    ...
    <div>
        ...
        <WorkflowBaseNode v-model:currentNode="currentNode" :id="props.id" :meta="saveToFileLCMeta" @not-found="() => { }">
                        ...
                        <Select v-model="currentNode.data.fileType">
                            ...
                            <SelectContent>
                                <SelectGroup>
                                    ...
                                    <SelectItem v-for="(value, key) in EXT_MIME_MAP" :key="key" :value="key">{{ key.toUpperCase() }}</SelectItem>
