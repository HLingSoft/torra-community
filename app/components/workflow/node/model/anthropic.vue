...
const currentNode = ref<{ id: string, data: ChatAnthropicData } | null>(null)
...
<template>
    ...
    <div>
        <WorkflowBaseNode v-model:currentNode="currentNode" :id="props.id" :meta="chatAnthropicMeta" @not-found="() => { }">
