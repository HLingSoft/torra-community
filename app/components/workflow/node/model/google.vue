...
import { chatGoogleGenerativeAIMeta } from '~~/types/node-data/chat-google'



const props = defineProps<{ id: string }>()
const currentNode = ref<{ id: string, data: ChatGoogleGenerativeAIData } | null>(null)
...
<template>
    ...
    <div>
        <WorkflowBaseNode v-model:currentNode="currentNode" :id="props.id" :meta="chatGoogleGenerativeAIMeta" @not-found="() => { }">
