...
const { nodes, edges,vueFlowRef } = storeToRefs(useWorkflowStore())
...
background-size: 50px 50px; background-color: #1e1e1e;"
      >
        <VueFlow @init="onFlowInit" ref="vueFlowRef" fit-view-on-init  :nodes="nodes" :edges="edges"   :default-viewport="{ zoom: 0.8 }"   :max-zoom="4" :min-zoom="0.1">
