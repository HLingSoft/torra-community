  ...
  <div class="dark  ">
    <ClientOnly>
      <SidebarProvider>
        ...
        <SidebarInset>
          <header :class="{'pr-72':!isCollapsed}" class=" transition-all duration-200 flex fixed z-50 w-full  top-0  bg-[#18181B] h-16 shrink-0 items-center gap-2 border-b border-[hsl(var(--border))] px-4">
