...
onMounted(async () => {
  // useToast('新建工作流成功')
  const position = project({ x: 0, y: 0 }) // 👈 关键位置
  addNodes([
    {
      id: nanoid(),
      type: 'customNode',
      position,
      data: { label: 'Top Left Node' }
    }
  ])
    ...
    <ClientOnly>
      <SidebarProvider>
        ...
        <SidebarInset>
          ...
          <header class=" flex fixed z-50 w-full py-5  top-0  bg-[#18181B] h-16 shrink-0 items-center gap-2 border-b border-[hsl(var(--border))] px-4">
            ...
            <div>
              ...
              <DropdownMenu v-if="user">
                <DropdownMenuTrigger as-child @click.stop>
                  <Button variant="secondary" size="icon" class="rounded-full">
                    <div class="avatar online ">
                      <div class="w-5 rounded-full ring ring-offset-2 ring-white ring-offset-base-100">
                        <img :src="user.avatar" />
                      </div>
                    </div>
                ...
                <DropdownMenuContent class="w-56 space-y-3 dark" align="center" side="bottom">
                  ...
                  <DropdownMenuItem class="cursor-pointer  py-2.5" @click="navigateTo('/me/profile')">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger as-child>
                  <Button size="sm" variant="outline" class="w-full text-white">
                    ...
                    <div v-else>
                      <!-- <div class="skeleton h-1 w-28 bg-gray-100"></div> -->
                    ...
                    <DialogContent class="sm:max-w-[425px] dark text-white">
                      ...
                      <div class="grid gap-4 py-4">
                        ...
                        <div class="grid grid-cols-4 items-center gap-4">
                          ...
                          <Input id="username" v-model="newWorkflow.description" class="col-span-3" />
                        </div>
                      </div>
                      <DialogFooter>
            ...
            <Button size="sm" variant="outline" class="hidden md:flex " @click="saveWorkflow">
                <div class="flex items-center space-x-2 text-white">
            ...
            <Button :disabled="!currentWorkflow || !currentWorkflow.objectId" size="sm" variant="outline" class="hidden md:flex " @click="deleteWorkflow">
                <div class="flex items-center space-x-2 text-white">
                  <NuxtIcon name="openmoji:delete" size="18" />
                  <div>Delete</div>
                </div>
              </Button>
              ...
              <Button :disabled="!currentWorkflow || !currentWorkflow.objectId" size="sm" variant="link" class="hidden md:flex   ">
                <div class="flex items-center space-x-2">
