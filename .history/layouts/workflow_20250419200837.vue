...
import { useSidebar } from '@/components/ui/sidebar' // 实际路径根据项目修改
  ...
  <div class="dark  ">
    <ClientOnly>
      <SidebarProvider>
        <WorkflowSidebar    />
        <SidebarInset>
          <header :class="  isCollapsed ? 'pl-16' : 'pl-64' " class=" flex fixed z-50  top-0  bg-[#18181B] h-16 shrink-0 items-center gap-2 border-b border-[hsl(var(--border))] px-4">
