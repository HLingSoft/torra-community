  ...
  <div class="dark  ">
    <ClientOnly>
      <SidebarProvider>
        ...
        <SidebarInset>
          <header :class="{'w-[calc(100vw-16rem)]':isCollapsed}" class=" flex fixed z-50 w-full  top-0  bg-[#18181B] h-16 shrink-0 items-center gap-2 border-b border-[hsl(var(--border))] px-4">
