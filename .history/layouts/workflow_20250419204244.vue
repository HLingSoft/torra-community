                ...
                <div>
                  ...
                  <DropdownMenu v-if="user">
                    ...
                    <DropdownMenuContent class="w-56 space-y-3 dark" align="center" side="bottom">
                      ...
                      <DropdownMenuItem class="cursor-pointer  py-4" @click="navigateTo('/me/profile')">
                        <NuxtIcon name="iconamoon:profile-light" size="18" /> 个人信息
                      </DropdownMenuItem>

                      <DropdownMenuItem :disabled="true" class="cursor-pointer  py-2">
                        <NuxtIcon name="hugeicons:money-bag-01" size="18" />财务中心
                      </DropdownMenuItem>

                      <DropdownMenuItem class="cursor-pointer py-2" @click="userlogOut"  >
