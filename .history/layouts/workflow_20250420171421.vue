...
<div>
                <Select>
    <SelectTrigger>
      <SelectValue  :value="currentWorkspace?.name|| ''" />
    </SelectTrigger>
    <SelectContent class="w-56 dark max-h-56">
      <SelectGroup>

        <SelectItem :value="workspace.objectId" v-for="workspace in allWorkflows" :key="workspace.objectId" @click="currentWorkflow=workspace">
          {{ workspace.name }}
