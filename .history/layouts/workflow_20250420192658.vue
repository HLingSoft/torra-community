      ...
      <SidebarProvider>
        ...
        <SidebarInset>
          ...
          <header class=" flex fixed z-50 w-full py-5  top-0  bg-[#18181B] h-16 shrink-0 items-center gap-2 border-b border-[hsl(var(--border))] px-4">
            ...
            <Button size="sm" variant="outline" class="hidden md:flex mx-5" @click="saveWorkflow">
                <div class="flex items-center space-x-2 text-white">
            ...
            <Button size="sm" variant="outline" class="hidden md:flex mx-5" @click="deleteWorkflow">
                <div class="flex items-center space-x-2 text-white">
              ...
              <Button size="sm" variant="destructive" class="hidden md:flex mx-5" @click="playWorkflow">
                <div class="flex items-center space-x-2">
                  <NuxtIcon name="solar:play-broken" size="18" />
                  <div>Playground</div>
                </div>
              </Button>
              <Button size="sm" variant="link" class="hidden md:flex  mx-5">
                <div class="flex items-center space-x-2">
