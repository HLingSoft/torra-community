...
// import { WorkflowSearch } from '.nuxt/components'
...
<template>
  <Sidebar v-bind="props" class="dark bg-[#18181B] text-white border-[hsl(var(--border))] ">
    <SidebarHeader>
      <WorkflowVersionSwitcher :versions="data.versions" :default-version="data.versions[0]" />
      <WorkflowSearch />
    </SidebarHeader>
    <SidebarContent>
      <ScrollArea>
              ...
              <SidebarMenuItem v-for="childItem in item.items" :key="childItem.title" class="bg-[#27272A]/75 cursor-default p-2 rounded-lg">
                <SidebarMenuButton as-child :is-active="childItem.isActive">
                  <div class="relative  flex   items-center justify-between ">
                    <a :href="childItem.url" class="peer  w-full">{{ childItem.title }}</a>
                    <div v-if="childItem.component " class="absolute z-10 w-full pr-4 transition-all duration-150 hover:opacity-100 opacity-0 flex justify-end">
                      <div class="  flex  items-center gap-x-2    cursor-pointer">
                        <div class="  bg-[#27272A]   rounded-lg p-1 flex items-center justify-center" @click="addNode(childItem.component, { x: 50, y: 100 })">
                        ...
                        <HoverCard>
                          ...
                          <HoverCardContent class="dark w-80 prose prose-neutral prose-sm">
