    ...
    <SidebarMenuItem>
      <DropdownMenu>
        <DropdownMenuTrigger as-child>
          ...
          >
            <div class="flex bg-white aspect-square size-8 items-center justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground">
        ...
        <DropdownMenuContent
          class="w-[--reka-dropdown-menu-trigger-width] dark"
          align="start"
        >
          <DropdownMenuItem
