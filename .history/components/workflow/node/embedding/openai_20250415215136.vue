      ...
      <div ref="openaiAPIKeyRef">
        ...
        <div class="w-full  mt-5">
          <div v-if="!currentNode.data.apiKeyVariable.connected" class="relative">
            ...
            <NuxtIcon v-if="currentNode.data.apiKeyVariable.show" name="lets-icons:view-duotone" size="24" class="cursor-pointer" @click="currentNode.data.apiKeyVariable.show = false" />
