...
await until(currentWorkflow).toBeTruthy()
  ...
  if (!node.data.saved && currentWorkflow.value) {
...
<template>
  <Card v-if="currentNode && currentNode.data && currentNode.data.sessionId" class="!pb-0 w-96 text-white bg-[#18181B]  rounded-lg  flex flex-col focus:outline-none  focus:shadow-lg focus:shadow-[#000000]   focus:border focus:border-[#27272A]">
