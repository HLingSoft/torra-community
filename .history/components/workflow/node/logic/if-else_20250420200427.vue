      ...
      <div ref="matchTextRef">
        ...
        <div class="w-full  mt-5">
          <div class="filter dark">
            ...
            <input class="btn btn-sm btn-outline" type="radio"     v-model="matchType" name="matchType"  aria-label="String"/>
            <input class="btn  btn-sm  btn-outline" type="radio"     v-model="matchType" name="matchType" aria-label="Boolean"/>
