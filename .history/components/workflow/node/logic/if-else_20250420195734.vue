...
watch(()=>currentNode.data!.matchType,()=>{
    ...
    <CardContent class="text-white space-y-8 -mt-8  flex-1 nodrag nopan cursor-auto ">
      ...
      <div ref="matchTextRef">
        ...
        <div class="w-full  mt-5">
          ...
          <input class="btn  btn-sm btn-outline filter-reset" v-model="currentNode.data.matchType" type="radio" name="matchType" aria-label="All"/>
