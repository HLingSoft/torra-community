      ...
      <div ref="matchTextRef">
        ...
        <div class="w-full  mt-5">
          <div class="filter dark">
            <input class="btn  btn-sm btn-outline filter-reset" type="radio"     @change="matchType = 'All'"  name="matchType" aria-label="All"/>
            <input class="btn btn-sm btn-outline" type="radio"       aria-label="String"/>
            <input class="btn  btn-sm  btn-outline" type="radio"      aria-label="Boolean"/>
