      ...
      <div ref="matchTextRef">
        ...
        <div class="w-full  mt-5">
          <div class="filter dark">
            <input class="btn  btn-sm btn-outline filter-reset" type="radio"  v-model="matchType"  value="All"     name="matchType" aria-label="All"/>
            <input class="btn btn-sm btn-outline" type="radio"     value="String"   v-model="matchType"   name="matchType" aria-label="String"/>
            <input class="btn  btn-sm  btn-outline" type="radio"    value="Boolean"   v-model="matchType"    name="matchType"   aria-label="Boolean"/>
