    ...
    <CardContent class="text-white space-y-8 -mt-8  flex-1 nodrag nopan cursor-auto ">
      ...
      <div ref="matchTextRef">
        ...
        <div class="w-full  mt-5">
          ...
          <input class="btn filter-reset" type="radio" name="matchType" aria-label="All"/>
          <input class="btn" type="radio" name="matchType" aria-label="String"/>
          <input class="btn" type="radio" name="matchType" aria-label="Boolean"/>
