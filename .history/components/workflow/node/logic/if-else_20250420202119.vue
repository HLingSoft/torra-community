...
// const matchType = ref('')
// watch(matchType,()=>{
//   console.log('currentNode.data.matchType',  matchType.value)
//   if (currentNode.value?.data) {
//     currentNode.value.data.matchType = matchType.value
//   }
// })
</script>
      ...
      <div ref="matchTextRef">
        ...
        <div class="w-full  mt-5">
          <div class="filter dark">
            <input class="btn  btn-sm btn-outline filter-reset" type="radio"  v-model="currentNode.value.data.matchType"  value="All"     name="matchType" aria-label="All"/>
            <input class="btn btn-sm btn-outline" type="radio"     value="String"   v-model="currentNode.value.data.matchType"   name="matchType" aria-label="String"/>
            <input class="btn  btn-sm  btn-outline" type="radio"    value="Boolean"   v-model="currentNode.value.data.matchType"    name="matchType"   aria-label="Boolean"/>
