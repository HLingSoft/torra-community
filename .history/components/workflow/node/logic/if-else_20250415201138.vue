...
<template>
  <Card v-if=" currentNode && currentNode.data" class="!pb-0 w-96 text-white bg-[#18181B]   rounded-lg group flex flex-col focus:outline-none  focus:shadow-lg focus:shadow-[#000000]   focus:border focus:border-[#27272A]">
    <NodeCardHeader :nodeData="currentNode.data" :id="id"/>
    ...
    <CardContent class="text-white space-y-8  flex-1 nodrag nopan cursor-auto ">
      ...
      <div ref="textInputRef">
        ...
        <div class="w-full  mt-5">
          <div v-if="!currentNode.data.textInputVariable.connected" class="relative">
            <Input class="w-full" type="text" v-model="currentNode.data.textInputVariable.value" placeholder="Typing something" />
      ...
      <div ref="matchTextRef">
        ...
        <div class="w-full  mt-5">
          ...
          <div v-if="!currentNode.data.matchTextVariable.connected" class="relative">
            <Input class="w-full" type="text" v-model="currentNode.data.matchTextVariable.value" placeholder="Typing something" />
            <NuxtIcon name="solar:global-line-duotone" size="18" class=" absolute z-10 right-2 bottom-2.5 cursor-pointer" />
          </div>
          <div v-else>
            <Input disabled class="w-full" type="text" placeholder="Receiving input" />
      ...
      <div ref="messageRef">
        ...
        <div class="w-full  mt-5">
          <div v-if="!currentNode.data.messageVariable.connected" class="relative">
            <Input class="w-full" type="text" v-model="currentNode.data.messageVariable.value" placeholder="Typing something" />
            <NuxtIcon name="solar:global-line-duotone" size="18" class=" absolute z-10 right-2 bottom-2.5 cursor-pointer" />
          </div>
          <div v-else>
            <Input disabled class="w-full" type="text" placeholder="Receiving input" />
