...
onMounted(async () => {
  ...
  if(!currentNode.value.data?.inputValue){
    currentNode.value.data!.inputValue = nanoLowercaseAlphanumericId(10)
  }
    ...
    <CardContent class="text-white flex flex-col space-y-8 -mt-8 flex-1">
      ...
      <div>
        ...
        <div class="w-full mt-5">
          <div class="relative">
            <Input class="w-full" type="text" v-model="currentNode.data.inputValue " placeholder="Typing something" />
