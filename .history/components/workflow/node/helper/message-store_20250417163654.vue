    ...
    <CardContent class="text-white flex flex-col space-y-8 -mt-8 flex-1 ">
      ...
      <div ref="messageInputVariableRef">
        ...
        <div class="w-full  mt-5">
          <div v-if="!currentNode.data.messageInputVariable.connected" class="relative">
            <Input v-model="currentNode.data.messageInputVariable.value" class="w-full" type="text" placeholder="" />
