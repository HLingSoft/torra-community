...
<template>
  <Card v-if=" currentNode && currentNode.data" class="w-96 text-white bg-[#18181B] text-sm rounded-lg  flex flex-col focus:outline-none  focus:shadow-lg focus:shadow-[#000000]   focus:border focus:border-[#27272A]">
