...
<template>
  <Card v-if="currentNode && currentNode.data" class="w-96 bg-[#18181B] text-white rounded-lg border border-[#27272A]">
    <NodeCardHeader :nodeData="currentNode.data" :id="props.id" />
    <CardContent class="space-y-5 mt-3">
      <div ref="collectionNameRef">
        <Label>Collection Name</Label>
        <Input v-model="currentNode.data.collectionNameVariable.value" placeholder="e.g. system_01" />
      </div>
      ...
      <div ref="embeddingRef">
        ...
        <Input placeholder="Receiving vector input" disabled />
      </div>
