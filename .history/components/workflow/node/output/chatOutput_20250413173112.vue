...
<template>
  ...
  <Card v-if="currentNode && currentNode.data" class="w-96 text-white bg-[#18181B]  rounded-lg group flex flex-col focus:outline-none  focus:shadow-lg focus:shadow-[#000000] text-sm focus:border focus:border-[#27272A]">
    <CardHeader>
