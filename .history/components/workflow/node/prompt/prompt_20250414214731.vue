...
<template>
  <Card
    ...
    class="!pb-0 w-96 text-white bg-[#18181B] rounded-lg group flex flex-col focus:outline-none focus:shadow-lg focus:shadow-[#000000] text-sm focus:border focus:border-[#27272A]"
  >
    <CardHeader>
      ...
      <div>
        ...
        <div class="w-full mt-5">
          <AlertDialog>
            ...
            <AlertDialogContent class="dark text-white w-full max-w-7xl text-sm">
              <AlertDialogHeader>
              ...
              <AlertDialogFooter class="w-full flex flex-row items-center justify-between">
                <div class="w-full flex flex-col">
                  <AlertDialogTitle class="text-base">
                    {} Prompt Variables:<span v-for="variable in inputVariables" :key="variable.name" class="text-white bg-gray-700 rounded-full px-2 py-1 mx-1 text-sm">{{ variable.name }}</span>
                  </AlertDialogTitle>
                  <AlertDialogDescription>
    ...
    <Dialog v-model:open="editVariableTextValueComponent">
      <DialogContent class="dark text-white w-full max-w-7xl text-sm">
        <DialogHeader>
