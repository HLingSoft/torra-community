        ...
        <Command>
          ...
          <CommandList>
            ...
            <CommandGroup heading="Suggestions">
              <CommandItem class="!py-1"  v-for="variable in variables" :key="variable.name" :value="variable.value" @select="selectVariable(variable)">
                <div class="flex flex-col    ">
                  <div class="font-medium text-xs">{{ variable.name }}</div>
                  <div class="text-xs text-muted-foreground    line-clamp-1 ">{{ variable.value }}</div>
                </div>
              </CommandItem>
            </CommandGroup>
