...
<template>
    ...
    <Popover class="w-full" v-model:open="openPopover">
      ...
      <PopoverContent class="p-0 dark  ">
        ...
        <div class="border-t px-3 py-2 w-full">
          ...
          <Button variant="ghost" size="sm" class="w-full flex flex-row items-center gap-x-2">
  ...
  <Dialog :open="dialogOpen" @update:open="dialogOpen = $event">
    <DialogContent class="dark text-white w-full text-sm !max-w-7xl ">
      <DialogHeader>
        <DialogTitle> <NuxtIcon name="solar:global-line-duotone" size="18" />Create Variable</DialogTitle>
