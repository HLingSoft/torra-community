      ...
      <DialogHeader>
       ...
       <div>
        <div class="grid w-full max-w-sm items-center gap-1.5">
          ...
          <Input id="name" type="text" placeholder="Enter a name for variable..." v-model="currentVariable.name" />
        </div>
        <div class="grid w-full max-w-sm items-center gap-1.5">
          <Label for="name">Value</Label>
          <Input id="name" type="text" placeholder="Enter a value for variable..." v-model="currentVariable.value" />
        </div>
       </div>
