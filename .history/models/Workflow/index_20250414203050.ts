...
class Workflow extends AV.Object {
  ...
  public tempVars: Record<string, anyn> = {}
  ...
  constructor() {
    ...
    return new Proxy(this, {
      ...
      set(target, prop: string | symbol, value: anyn) {
        // 如果 prop 是 symbol，直接返回默认行为
        if (typeof prop !== 'string') {
  ...
  set nodes(value: anyn[] | undefined) {
  ...
  set edges(value: anyn[] | undefined) {
    this.set('edges', value)
  }

  [key: `temp_${string}`]: anyn
}
