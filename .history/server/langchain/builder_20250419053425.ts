...
// ✅ Step 3: 再剪枝（剪掉 skipPort 的所有 downstream）
...
// ✅ Step 4: rebuild input connections
inputConnections = buildInputConnections(json)

// ✅ Step 5: 过滤出还没执行 & 没被剪掉的 active 分支节点
