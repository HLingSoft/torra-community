...
export async function milvusFactory(node: FlowNode, context: BuildContext) {
  ...
  const partitionValue = inputValues[partitionKeyVariable.name]
  ...
  if(partitionValue && partitionKey){
    ...
    filter[partitionKey] = partitionValue
  }
  // const filter: Record<string, string> = {
  //   projectId: '678316639d433b7c961e95f8',
  // }
  const results = await vectorStore.similaritySearch(query, 5,{
    projectId: '678316639d433b7c961e95f8', // ✅ 必须要有！
  })
