import type {
  ...
  export const messageToDataFactory: NodeFactory = async (
    ...
    console.log(message.toDict().data)

    const textMessage = await load(JSON.stringify(new AIMessage('你是谁')) as BaseMessage
    console.log(textMessage.toDict().data)
