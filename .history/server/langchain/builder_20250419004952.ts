...
// console.log('json',json)
  ...
  for (let i = 0; i < sortedIds.length; i++) {
    ...
    // if (isTerminal) {
    //   console.log('终止节点:', node.id,nodeResult)
    //   finalMessage =await normalizeOutput(nodeResult['nvag18kfph'])
  ...
  const lastNodeResultValue = lastNodeResult[lastNode.data.outputVariable.id]
